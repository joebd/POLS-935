...
# You can pipe the above directly into ggplot and not specify data beyond the
# "." default sign. I wanted to do it separately for clarity purposes.
ggplot(data = desc_tf_idf,
       aes(tf_idf, word, fill = keyword)) +
...
desc_lda <- LDA(desc_dtm, k = 24, control = list(seed = 1000))
```
